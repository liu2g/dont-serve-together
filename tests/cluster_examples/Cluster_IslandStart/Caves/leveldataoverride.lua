return {
  ...
  custom_settings_id="CUSTOM_TEMPLATE_A_CAVE",
  custom_settings_name="template_a_cave",
  custom_worldgen_desc="",
  custom_worldgen_id="CUSTOM_TEMPLATE_A_CAVE",
  custom_worldgen_name="template_a_cave",
  desc="探查洞穴…… 一起！",
  hideminimap=false,
  id="DST_CAVE",
  location="cave",
