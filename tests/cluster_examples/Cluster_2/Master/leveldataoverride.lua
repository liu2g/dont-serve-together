return {
  ...
  custom_settings_id="CUSTOM_TEMPLATE_A_FOREST",
  custom_settings_name="template_a_forest",
  custom_worldgen_desc="",
  custom_worldgen_id="CUSTOM_TEMPLATE_A_FOREST",
  custom_worldgen_name="template_a_forest",
  desc="标准《饥荒》体验。",
  hideminimap=false,
